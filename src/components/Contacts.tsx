...
<h2
  className="mb-6 text-[32px] font-bold uppercase text-dark sm:text-[40px] lg:text-[36px] xl:text-[40px] dark:text-white">
  GET IN TOUCH WITH US
</h2>
<p className="mb-9 text-base leading-relaxed text-gray-500 dark:text-dark-6">
  Ready to elevate your online presence? Whether you need SEO support, a custom website, or both — our team is here to help you grow, rank, and convert.
</p>


            <div className="mb-8 flex w-full max-w-[370px]">
              <div
                className="mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded-sm bg-primary/5 text-blue-600 sm:h-[70px] sm:max-w-[70px]">
            ...
            <form>
              <div className="mb-6">
                <input type="text" placeholder="Your Name"
                  className="w-full rounded-sm border border-gray-200 px-[14px] py-3 text-base text-gray-500 outline-hidden focus:border-blue-600 dark:border-dark-3 dark:bg-dark dark:text-dark-6" />
              </div>
              <div className="mb-6">
              ...
              <div className="mb-6">
                <textarea  placeholder="Your Message" rows={10}
                  className="w-full resize-none rounded-sm border border-gray-200 px-[14px] py-3 text-base text-gray-500 outline-hidden focus:border-blue-600 dark:border-dark-3 dark:bg-dark dark:text-dark-6"></textarea>
              </div>
              <div>
                <button type="submit"
                  className="w-full rounded-sm border border-blue-600 bg-blue-600 p-3 text-white transition hover:bg-primary/90">
                  Send Message
                </button>
              </div>
            </form>
